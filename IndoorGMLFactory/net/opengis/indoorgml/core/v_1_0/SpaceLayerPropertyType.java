...
/**
 * <p>SpaceLayerPropertyType complex type에 대한 Java 클래스입니다.
 * 
...
public class SpaceLayerPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetSpaceLayer() {
        return (this.spaceLayer!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            SpaceLayerType theSpaceLayer;
            theSpaceLayer = this.getSpaceLayer();
            strategy.appendField(locator, this, "spaceLayer", buffer, theSpaceLayer, this.isSetSpaceLayer());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SpaceLayerPropertyType that = ((SpaceLayerPropertyType) object);
        {
            SpaceLayerType lhsSpaceLayer;
            lhsSpaceLayer = this.getSpaceLayer();
            SpaceLayerType rhsSpaceLayer;
            rhsSpaceLayer = that.getSpaceLayer();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "spaceLayer", lhsSpaceLayer), LocatorUtils.property(thatLocator, "spaceLayer", rhsSpaceLayer), lhsSpaceLayer, rhsSpaceLayer, this.isSetSpaceLayer(), that.isSetSpaceLayer())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SpaceLayerType theSpaceLayer;
            theSpaceLayer = this.getSpaceLayer();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "spaceLayer", theSpaceLayer), currentHashCode, theSpaceLayer, this.isSetSpaceLayer());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SpaceLayerPropertyType) {
            final SpaceLayerPropertyType copy = ((SpaceLayerPropertyType) draftCopy);
            {
                Boolean spaceLayerShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSpaceLayer());
                if (spaceLayerShouldBeCopiedAndSet == Boolean.TRUE) {
                    SpaceLayerType sourceSpaceLayer;
                    sourceSpaceLayer = this.getSpaceLayer();
                    SpaceLayerType copySpaceLayer = ((SpaceLayerType) strategy.copy(LocatorUtils.property(locator, "spaceLayer", sourceSpaceLayer), sourceSpaceLayer, this.isSetSpaceLayer()));
                    copy.setSpaceLayer(copySpaceLayer);
                } else {
                    if (spaceLayerShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.spaceLayer = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SpaceLayerPropertyType) {
            final SpaceLayerPropertyType target = this;
            final SpaceLayerPropertyType leftObject = ((SpaceLayerPropertyType) left);
            final SpaceLayerPropertyType rightObject = ((SpaceLayerPropertyType) right);
            {
                Boolean spaceLayerShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSpaceLayer(), rightObject.isSetSpaceLayer());
                if (spaceLayerShouldBeMergedAndSet == Boolean.TRUE) {
                    SpaceLayerType lhsSpaceLayer;
                    lhsSpaceLayer = leftObject.getSpaceLayer();
                    SpaceLayerType rhsSpaceLayer;
                    rhsSpaceLayer = rightObject.getSpaceLayer();
                    SpaceLayerType mergedSpaceLayer = ((SpaceLayerType) strategy.merge(LocatorUtils.property(leftLocator, "spaceLayer", lhsSpaceLayer), LocatorUtils.property(rightLocator, "spaceLayer", rhsSpaceLayer), lhsSpaceLayer, rhsSpaceLayer, leftObject.isSetSpaceLayer(), rightObject.isSetSpaceLayer()));
                    target.setSpaceLayer(mergedSpaceLayer);
                } else {
                    if (spaceLayerShouldBeMergedAndSet == Boolean.FALSE) {
                        target.spaceLayer = null;
                    }
                }
            }
            {
    ...
    public SpaceLayerPropertyType withSpaceLayer(SpaceLayerType value) {
        setSpaceLayer(value);
        return this;
    }

    public SpaceLayerPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SpaceLayerPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SpaceLayerPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public SpaceLayerPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SpaceLayerPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SpaceLayerPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SpaceLayerPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SpaceLayerPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SpaceLayerPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SpaceLayerPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SpaceLayerPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
