...
/**
 * <p>StateMemberType complex type에 대한 Java 클래스입니다.
 * 
...
@XmlType(name = "StateMemberType", propOrder = {
    "state"
})
public class StateMemberType
    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final StateMemberType that = ((StateMemberType) object);
        {
            StateType lhsState;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof StateMemberType) {
            final StateMemberType copy = ((StateMemberType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof StateMemberType) {
            final StateMemberType target = this;
            final StateMemberType leftObject = ((StateMemberType) left);
            final StateMemberType rightObject = ((StateMemberType) right);
            {
    ...
    public StateMemberType withState(StateType value) {
        setState(value);
        return this;
    }

    public StateMemberType withNilReason(String... values) {
        if (values!= null) {
    ...
    public StateMemberType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public StateMemberType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public StateMemberType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public StateMemberType withHref(String value) {
        setHref(value);
        return this;
    }

    public StateMemberType withRole(String value) {
        setRole(value);
        return this;
    }

    public StateMemberType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public StateMemberType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public StateMemberType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public StateMemberType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public StateMemberType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
