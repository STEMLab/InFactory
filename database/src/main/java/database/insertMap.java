...
public class insertMap {
	public static void insert(Connection connection, IndoorGMLMap map) {
	...
	public static String createInsertSql4IndoorFeatures(IndoorFeatures feature) {
		...
		String sql = "Insert into"+tableName+"values("+id+","+name+","+description+","+primalspacefeatures+","+multilayeredgraph+")";
		return sql;
	...
	public static String createInsertSql4PrimalSpaceFeatures(PrimalSpaceFeatures feature) {
		...
		sql = "Insert into"+tableName+"values("+id+","+parentid+","+name+","+description+","+csm+","+csbm+")";
		return sql;
	...
	public static String createInsertSql4CellSpace(CellSpace feature) {
		...
		sql = "Insert into"+tableName+"values("+id+","+parentid+","+name+","+description+","+duality+","+partiallboundedby+","+geom+")";
		return sql;
	}
	public static String createInsertSql4CellSpaceBoundary(CellSpaceBoundary feature) {
		...
		sql = "Insert into"+tableName+"values("+id+","+parentid+","+name+","+description+","+duality+","+geom+")";
		return sql;
	}
	...
	public static String createInsertSql4State(State feature) {
		...
		sql = "Insert into"+tableName+"values("+id+","+parentid+","+name+","+description+","+duality+","+connects+","+geom+")";
		return sql;
	}
