...
/**
 * <p>MultiLayeredGraphPropertyType complex type에 대한 Java 클래스입니다.
 * 
...
public class MultiLayeredGraphPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MultiLayeredGraphPropertyType that = ((MultiLayeredGraphPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiLayeredGraphPropertyType) {
            final MultiLayeredGraphPropertyType copy = ((MultiLayeredGraphPropertyType) draftCopy);
            {
                ...
                if (multiLayeredGraphShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    MultiLayeredGraphType copyMultiLayeredGraph = ((MultiLayeredGraphType) strategy.copy(LocatorUtils.property(locator, "multiLayeredGraph", sourceMultiLayeredGraph), sourceMultiLayeredGraph, this.isSetMultiLayeredGraph()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiLayeredGraphPropertyType) {
            final MultiLayeredGraphPropertyType target = this;
            final MultiLayeredGraphPropertyType leftObject = ((MultiLayeredGraphPropertyType) left);
            final MultiLayeredGraphPropertyType rightObject = ((MultiLayeredGraphPropertyType) right);
            {
    ...
    public MultiLayeredGraphPropertyType withMultiLayeredGraph(MultiLayeredGraphType value) {
        setMultiLayeredGraph(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MultiLayeredGraphPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MultiLayeredGraphPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MultiLayeredGraphPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
