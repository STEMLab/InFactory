...
public class Container {
	 ...
	 */
	public void setContainer(ConcurrentHashMap<String, IndoorGMLMap> container) {
		this.docContainer = container;
	}
	public void setDocument(String docID){
		IndoorGMLMap map = new IndoorGMLMap();
		docContainer.put(docID,map);
	}
	public void setDocument(String docID, IndoorGMLMap map){
		docContainer.put(docID, map);
	}
