...
/**
 * <p>CellSpaceBoundaryMemberType complex type에 대한 Java 클래스입니다.
 * 
    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CellSpaceBoundaryMemberType that = ((CellSpaceBoundaryMemberType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CellSpaceBoundaryMemberType) {
            final CellSpaceBoundaryMemberType copy = ((CellSpaceBoundaryMemberType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof CellSpaceBoundaryMemberType) {
            final CellSpaceBoundaryMemberType target = this;
            final CellSpaceBoundaryMemberType leftObject = ((CellSpaceBoundaryMemberType) left);
            final CellSpaceBoundaryMemberType rightObject = ((CellSpaceBoundaryMemberType) right);
            {
    ...
    public CellSpaceBoundaryMemberType withCellSpaceBoundary(JAXBElement<? extends CellSpaceBoundaryType> value) {
        setCellSpaceBoundary(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CellSpaceBoundaryMemberType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CellSpaceBoundaryMemberType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withHref(String value) {
        setHref(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withRole(String value) {
        setRole(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CellSpaceBoundaryMemberType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
