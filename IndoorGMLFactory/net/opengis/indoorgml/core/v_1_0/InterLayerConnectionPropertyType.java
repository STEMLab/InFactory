...
/**
 * <p>InterLayerConnectionPropertyType complex type에 대한 Java 클래스입니다.
 * 
...
public class InterLayerConnectionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final InterLayerConnectionPropertyType that = ((InterLayerConnectionPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof InterLayerConnectionPropertyType) {
            final InterLayerConnectionPropertyType copy = ((InterLayerConnectionPropertyType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof InterLayerConnectionPropertyType) {
            final InterLayerConnectionPropertyType target = this;
            final InterLayerConnectionPropertyType leftObject = ((InterLayerConnectionPropertyType) left);
            final InterLayerConnectionPropertyType rightObject = ((InterLayerConnectionPropertyType) right);
            {
    ...
    public InterLayerConnectionPropertyType withInterLayerConnection(InterLayerConnectionType value) {
        setInterLayerConnection(value);
        return this;
    }

    public InterLayerConnectionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public InterLayerConnectionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public InterLayerConnectionPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public InterLayerConnectionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public InterLayerConnectionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public InterLayerConnectionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public InterLayerConnectionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public InterLayerConnectionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public InterLayerConnectionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public InterLayerConnectionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public InterLayerConnectionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
