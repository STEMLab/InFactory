...
/**
 * <p>TransitionPropertyType complex type에 대한 Java 클래스입니다.
 * 
...
public class TransitionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            TransitionType theTransition;
            theTransition = this.getTransition();
            strategy.appendField(locator, this, "transition", buffer, theTransition, this.isSetTransition());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TransitionPropertyType that = ((TransitionPropertyType) object);
        {
            TransitionType lhsTransition;
            lhsTransition = this.getTransition();
            TransitionType rhsTransition;
            rhsTransition = that.getTransition();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "transition", lhsTransition), LocatorUtils.property(thatLocator, "transition", rhsTransition), lhsTransition, rhsTransition, this.isSetTransition(), that.isSetTransition())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TransitionType theTransition;
            theTransition = this.getTransition();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "transition", theTransition), currentHashCode, theTransition, this.isSetTransition());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TransitionPropertyType) {
            final TransitionPropertyType copy = ((TransitionPropertyType) draftCopy);
            {
                Boolean transitionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTransition());
                if (transitionShouldBeCopiedAndSet == Boolean.TRUE) {
                    TransitionType sourceTransition;
                    sourceTransition = this.getTransition();
                    TransitionType copyTransition = ((TransitionType) strategy.copy(LocatorUtils.property(locator, "transition", sourceTransition), sourceTransition, this.isSetTransition()));
                    copy.setTransition(copyTransition);
                } else {
                    if (transitionShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TransitionPropertyType) {
            final TransitionPropertyType target = this;
            final TransitionPropertyType leftObject = ((TransitionPropertyType) left);
            final TransitionPropertyType rightObject = ((TransitionPropertyType) right);
            {
                Boolean transitionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTransition(), rightObject.isSetTransition());
                if (transitionShouldBeMergedAndSet == Boolean.TRUE) {
                    TransitionType lhsTransition;
                    lhsTransition = leftObject.getTransition();
                    TransitionType rhsTransition;
                    rhsTransition = rightObject.getTransition();
                    TransitionType mergedTransition = ((TransitionType) strategy.merge(LocatorUtils.property(leftLocator, "transition", lhsTransition), LocatorUtils.property(rightLocator, "transition", rhsTransition), lhsTransition, rhsTransition, leftObject.isSetTransition(), rightObject.isSetTransition()));
                    target.setTransition(mergedTransition);
                } else {
                    if (transitionShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public TransitionPropertyType withTransition(TransitionType value) {
        setTransition(value);
        return this;
    }

    public TransitionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public TransitionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public TransitionPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public TransitionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public TransitionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public TransitionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public TransitionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public TransitionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public TransitionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TransitionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public TransitionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
