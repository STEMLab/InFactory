...
/**
 * <p>StatePropertyType complex type에 대한 Java 클래스입니다.
 * 
...
public class StatePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "state", buffer, theState, this.isSetState());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final StatePropertyType that = ((StatePropertyType) object);
        {
            StateType lhsState;
            lhsState = this.getState();
            StateType rhsState;
            rhsState = that.getState();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "state", lhsState), LocatorUtils.property(thatLocator, "state", rhsState), lhsState, rhsState, this.isSetState(), that.isSetState())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            StateType theState;
            theState = this.getState();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "state", theState), currentHashCode, theState, this.isSetState());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof StatePropertyType) {
            final StatePropertyType copy = ((StatePropertyType) draftCopy);
            {
                Boolean stateShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetState());
                if (stateShouldBeCopiedAndSet == Boolean.TRUE) {
                    StateType sourceState;
                    sourceState = this.getState();
                    StateType copyState = ((StateType) strategy.copy(LocatorUtils.property(locator, "state", sourceState), sourceState, this.isSetState()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof StatePropertyType) {
            final StatePropertyType target = this;
            final StatePropertyType leftObject = ((StatePropertyType) left);
            final StatePropertyType rightObject = ((StatePropertyType) right);
            {
                Boolean stateShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetState(), rightObject.isSetState());
                if (stateShouldBeMergedAndSet == Boolean.TRUE) {
                    StateType lhsState;
                    lhsState = leftObject.getState();
                    StateType rhsState;
                    rhsState = rightObject.getState();
                    StateType mergedState = ((StateType) strategy.merge(LocatorUtils.property(leftLocator, "state", lhsState), LocatorUtils.property(rightLocator, "state", rhsState), lhsState, rhsState, leftObject.isSetState(), rightObject.isSetState()));
                    target.setState(mergedState);
                } else {
                    if (stateShouldBeMergedAndSet == Boolean.FALSE) {
                        target.state = null;
                    }
                }
            }
    ...
    public StatePropertyType withState(StateType value) {
        setState(value);
        return this;
    }

    public StatePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public StatePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public StatePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public StatePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public StatePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public StatePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public StatePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public StatePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public StatePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public StatePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public StatePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
