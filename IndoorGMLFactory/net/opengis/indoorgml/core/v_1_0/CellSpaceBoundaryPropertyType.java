...
/**
 * <p>CellSpaceBoundaryPropertyType complex type에 대한 Java 클래스입니다.
 * 
...
public class CellSpaceBoundaryPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlElementRef(name = "CellSpaceBoundary", namespace = "http://www.opengis.net/indoorgml/1.0/core", type = JAXBElement.class, required = false)
    ...
    /**
     * cellSpaceBoundary 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
    ...
    /**
     * cellSpaceBoundary 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TransferBoundaryType }{@code >}
    ...
    public void setCellSpaceBoundary(JAXBElement<? extends CellSpaceBoundaryType> value) {
        this.cellSpaceBoundary = value;
    }

    public boolean isSetCellSpaceBoundary() {
        return (this.cellSpaceBoundary!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            JAXBElement<? extends CellSpaceBoundaryType> theCellSpaceBoundary;
            theCellSpaceBoundary = this.getCellSpaceBoundary();
            strategy.appendField(locator, this, "cellSpaceBoundary", buffer, theCellSpaceBoundary, this.isSetCellSpaceBoundary());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CellSpaceBoundaryPropertyType that = ((CellSpaceBoundaryPropertyType) object);
        {
            JAXBElement<? extends CellSpaceBoundaryType> lhsCellSpaceBoundary;
            lhsCellSpaceBoundary = this.getCellSpaceBoundary();
            JAXBElement<? extends CellSpaceBoundaryType> rhsCellSpaceBoundary;
            rhsCellSpaceBoundary = that.getCellSpaceBoundary();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cellSpaceBoundary", lhsCellSpaceBoundary), LocatorUtils.property(thatLocator, "cellSpaceBoundary", rhsCellSpaceBoundary), lhsCellSpaceBoundary, rhsCellSpaceBoundary, this.isSetCellSpaceBoundary(), that.isSetCellSpaceBoundary())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends CellSpaceBoundaryType> theCellSpaceBoundary;
            theCellSpaceBoundary = this.getCellSpaceBoundary();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cellSpaceBoundary", theCellSpaceBoundary), currentHashCode, theCellSpaceBoundary, this.isSetCellSpaceBoundary());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CellSpaceBoundaryPropertyType) {
            final CellSpaceBoundaryPropertyType copy = ((CellSpaceBoundaryPropertyType) draftCopy);
            {
                Boolean cellSpaceBoundaryShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCellSpaceBoundary());
                if (cellSpaceBoundaryShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends CellSpaceBoundaryType> sourceCellSpaceBoundary;
                    sourceCellSpaceBoundary = this.getCellSpaceBoundary();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends CellSpaceBoundaryType> copyCellSpaceBoundary = ((JAXBElement<? extends CellSpaceBoundaryType> ) strategy.copy(LocatorUtils.property(locator, "cellSpaceBoundary", sourceCellSpaceBoundary), sourceCellSpaceBoundary, this.isSetCellSpaceBoundary()));
                    copy.setCellSpaceBoundary(copyCellSpaceBoundary);
                } else {
                    if (cellSpaceBoundaryShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.cellSpaceBoundary = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CellSpaceBoundaryPropertyType) {
            final CellSpaceBoundaryPropertyType target = this;
            final CellSpaceBoundaryPropertyType leftObject = ((CellSpaceBoundaryPropertyType) left);
            final CellSpaceBoundaryPropertyType rightObject = ((CellSpaceBoundaryPropertyType) right);
            {
                Boolean cellSpaceBoundaryShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCellSpaceBoundary(), rightObject.isSetCellSpaceBoundary());
                if (cellSpaceBoundaryShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends CellSpaceBoundaryType> lhsCellSpaceBoundary;
                    lhsCellSpaceBoundary = leftObject.getCellSpaceBoundary();
                    JAXBElement<? extends CellSpaceBoundaryType> rhsCellSpaceBoundary;
                    rhsCellSpaceBoundary = rightObject.getCellSpaceBoundary();
                    JAXBElement<? extends CellSpaceBoundaryType> mergedCellSpaceBoundary = ((JAXBElement<? extends CellSpaceBoundaryType> ) strategy.merge(LocatorUtils.property(leftLocator, "cellSpaceBoundary", lhsCellSpaceBoundary), LocatorUtils.property(rightLocator, "cellSpaceBoundary", rhsCellSpaceBoundary), lhsCellSpaceBoundary, rhsCellSpaceBoundary, leftObject.isSetCellSpaceBoundary(), rightObject.isSetCellSpaceBoundary()));
                    target.setCellSpaceBoundary(mergedCellSpaceBoundary);
                } else {
                    if (cellSpaceBoundaryShouldBeMergedAndSet == Boolean.FALSE) {
                        target.cellSpaceBoundary = null;
                    }
                }
            }
            {
    ...
    public CellSpaceBoundaryPropertyType withCellSpaceBoundary(JAXBElement<? extends CellSpaceBoundaryType> value) {
        setCellSpaceBoundary(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CellSpaceBoundaryPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CellSpaceBoundaryPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CellSpaceBoundaryPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
