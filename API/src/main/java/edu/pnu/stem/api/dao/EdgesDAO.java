...
public class EdgesDAO {
	 ...
	 */
	public edu.pnu.stem.feature.Edges createEdges(String ID, String parentID, List<TransitionDAO> tl) {
		return null;
	};
	 ...
	 */
	public edu.pnu.stem.feature.Edges updateEdges(String ID, List<TransitionDAO> tl) {
		return null;
	};
