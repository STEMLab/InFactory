...
/**
 * <p>CellSpacePropertyType complex type에 대한 Java 클래스입니다.
 * 
...
public class CellSpacePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlElementRef(name = "CellSpace", namespace = "http://www.opengis.net/indoorgml/1.0/core", type = JAXBElement.class, required = false)
    ...
    public void setCellSpace(JAXBElement<? extends CellSpaceType> value) {
        this.cellSpace = value;
    }

    public boolean isSetCellSpace() {
        return (this.cellSpace!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            JAXBElement<? extends CellSpaceType> theCellSpace;
            theCellSpace = this.getCellSpace();
            strategy.appendField(locator, this, "cellSpace", buffer, theCellSpace, this.isSetCellSpace());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CellSpacePropertyType that = ((CellSpacePropertyType) object);
        {
            JAXBElement<? extends CellSpaceType> lhsCellSpace;
            lhsCellSpace = this.getCellSpace();
            JAXBElement<? extends CellSpaceType> rhsCellSpace;
            rhsCellSpace = that.getCellSpace();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cellSpace", lhsCellSpace), LocatorUtils.property(thatLocator, "cellSpace", rhsCellSpace), lhsCellSpace, rhsCellSpace, this.isSetCellSpace(), that.isSetCellSpace())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends CellSpaceType> theCellSpace;
            theCellSpace = this.getCellSpace();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cellSpace", theCellSpace), currentHashCode, theCellSpace, this.isSetCellSpace());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CellSpacePropertyType) {
            final CellSpacePropertyType copy = ((CellSpacePropertyType) draftCopy);
            {
                Boolean cellSpaceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCellSpace());
                if (cellSpaceShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends CellSpaceType> sourceCellSpace;
                    sourceCellSpace = this.getCellSpace();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends CellSpaceType> copyCellSpace = ((JAXBElement<? extends CellSpaceType> ) strategy.copy(LocatorUtils.property(locator, "cellSpace", sourceCellSpace), sourceCellSpace, this.isSetCellSpace()));
                    copy.setCellSpace(copyCellSpace);
                } else {
                    if (cellSpaceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.cellSpace = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CellSpacePropertyType) {
            final CellSpacePropertyType target = this;
            final CellSpacePropertyType leftObject = ((CellSpacePropertyType) left);
            final CellSpacePropertyType rightObject = ((CellSpacePropertyType) right);
            {
                Boolean cellSpaceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCellSpace(), rightObject.isSetCellSpace());
                if (cellSpaceShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends CellSpaceType> lhsCellSpace;
                    lhsCellSpace = leftObject.getCellSpace();
                    JAXBElement<? extends CellSpaceType> rhsCellSpace;
                    rhsCellSpace = rightObject.getCellSpace();
                    JAXBElement<? extends CellSpaceType> mergedCellSpace = ((JAXBElement<? extends CellSpaceType> ) strategy.merge(LocatorUtils.property(leftLocator, "cellSpace", lhsCellSpace), LocatorUtils.property(rightLocator, "cellSpace", rhsCellSpace), lhsCellSpace, rhsCellSpace, leftObject.isSetCellSpace(), rightObject.isSetCellSpace()));
                    target.setCellSpace(mergedCellSpace);
                } else {
                    if (cellSpaceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.cellSpace = null;
                    }
                }
            }
            {
    ...
    public CellSpacePropertyType withCellSpace(JAXBElement<? extends CellSpaceType> value) {
        setCellSpace(value);
        return this;
    }

    public CellSpacePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CellSpacePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CellSpacePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CellSpacePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CellSpacePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CellSpacePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CellSpacePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CellSpacePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CellSpacePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CellSpacePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CellSpacePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
