    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof StateType) {
            final StateType copy = ((StateType) draftCopy);
            {
                ...
                if (dualityShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    CellSpacePropertyType copyDuality = ((CellSpacePropertyType) strategy.copy(LocatorUtils.property(locator, "duality", sourceDuality), sourceDuality, this.isSetDuality()));
            ...
            }
            {
                ...
                if (connectsShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    List<TransitionPropertyType> copyConnects = ((List<TransitionPropertyType> ) strategy.copy(LocatorUtils.property(locator, "connects", sourceConnects), sourceConnects, this.isSetConnects()));
                    copy.unsetConnects();
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof StateType) {
            final StateType target = this;
            final StateType leftObject = ((StateType) left);
            final StateType rightObject = ((StateType) right);
            {
                ...
                if (dualityShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    CellSpacePropertyType mergedDuality = ((CellSpacePropertyType) strategy.merge(LocatorUtils.property(leftLocator, "duality", lhsDuality), LocatorUtils.property(rightLocator, "duality", rhsDuality), lhsDuality, rhsDuality, leftObject.isSetDuality(), rightObject.isSetDuality()));
            ...
            }
            {
                ...
                if (connectsShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    List<TransitionPropertyType> mergedConnects = ((List<TransitionPropertyType> ) strategy.merge(LocatorUtils.property(leftLocator, "connects", lhsConnects), LocatorUtils.property(rightLocator, "connects", rhsConnects), lhsConnects, rhsConnects, leftObject.isSetConnects(), rightObject.isSetConnects()));
                    target.unsetConnects();
                    if (mergedConnects!= null) {
                        List<TransitionPropertyType> uniqueConnectsl = target.getConnects();
    ...
    public void setConnects(List<TransitionPropertyType> value) {
        this.connects = null;
        if (value!= null) {
            List<TransitionPropertyType> draftl = this.getConnects();
            draftl.addAll(value);
        }
    }
    ...
    public StateType withDuality(CellSpacePropertyType value) {
        setDuality(value);
        return this;
    }

    public StateType withConnects(TransitionPropertyType... values) {
        if (values!= null) {
            for (TransitionPropertyType value: values) {
    ...
    public StateType withConnects(Collection<TransitionPropertyType> values) {
        if (values!= null) {
    ...
    public StateType withGeometry(PointPropertyType value) {
        setGeometry(value);
        return this;
    }

    public StateType withNilReason(String... values) {
        if (values!= null) {
    ...
    public StateType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public StateType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public StateType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public StateType withHref(String value) {
        setHref(value);
        return this;
    }

    public StateType withRole(String value) {
        setRole(value);
        return this;
    }

    public StateType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public StateType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public StateType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public StateType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public StateType withConnects(List<TransitionPropertyType> value) {
        setConnects(value);
        return this;
    }

    public StateType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
