...
/**
 * <p>RouteNodePropertyType complex type에 대한 Java 클래스입니다.
 * 
...
public class RouteNodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RouteNodePropertyType that = ((RouteNodePropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof RouteNodePropertyType) {
            final RouteNodePropertyType copy = ((RouteNodePropertyType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof RouteNodePropertyType) {
            final RouteNodePropertyType target = this;
            final RouteNodePropertyType leftObject = ((RouteNodePropertyType) left);
            final RouteNodePropertyType rightObject = ((RouteNodePropertyType) right);
            {
    ...
    public RouteNodePropertyType withRouteNode(RouteNodeType value) {
        setRouteNode(value);
        return this;
    }

    public RouteNodePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public RouteNodePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public RouteNodePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public RouteNodePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public RouteNodePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public RouteNodePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public RouteNodePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public RouteNodePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public RouteNodePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public RouteNodePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public RouteNodePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
